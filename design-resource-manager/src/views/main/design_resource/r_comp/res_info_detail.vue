<template>
  <el-drawer v-model="resInfoDetalDrawer" title="文件详情">
    ...
    <div style="font-size: var(--el-font-size-small)">
      ...
      <el-button
        type="text"
        @click.stop="handleSelectedResInfo(pickedResInfo, 'preview')"
        size="small"
        v-if="pickedResInfo.resInfoType == 'file'"
        >预览</el-button
      >
      <el-button
        type="text"
        @click.stop="handleSelectedResInfo(pickedResInfo, 'enter')"
        size="small"
        v-if="pickedResInfo.resInfoType == 'folder'"
        >进入</el-button
      >
